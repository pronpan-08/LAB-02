...
จาการทดลอง lab2 เมื่อพิมพ์โค๊ดตามที่ได้รับมอบหมายและทำการกด Ctrl+F5 จะแสดงหน้าต่างที่มีรูปวงกลม

 ![](https://github.com/pronpan-08/LAB-02/blob/master/imgs/lab2joy.png?raw=true)
